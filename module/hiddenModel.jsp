...
<html>
  ...
  <body>
  	<div class="container-fluid hidmodel">
	    <div class="row">
		    <s:iterator value="#request.models" var="model">	  					  					
			  	<div class="col-md-2" id="hidmodel">
			  		<a href="showModelRom.action?user.userid=<s:property value='#session.user.userid'/>&mfture.mftureid=<s:property value='#model.mfture.mftureid'/>&model.modelid=<s:property value='#model.modelid'/>&savehistory=1&currentPage=1" class="col-md-12">
