	...
	<div class="row  box-shadow">
	    <s:iterator value="#request.models" var="model">	  					  					
		  	<div class="col-md-3" id="model">
		  		<a href="showModelRom.action?user.userid=<s:property value='#session.user.userid'/>&model.modelid=<s:property value='#model.modelid'/>&savehistory=1&currentPage=1" class="col-md-12">
