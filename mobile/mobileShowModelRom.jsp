  ...
  <body>
	...
	<div class="mui-content">
		<div class="model-roms">
			<h4><a href="mobileShowRomDownload?currentPage=1">ROM</a> > <span><s:property value='#request.classmodel.model'/></span></h4>			
			<ul class="mui-table-view">
				<li class="mui-table-view-cell mui-collapse">
			  		<a class="mui-navigate-right" href="#">共<s:property value="#request.romnum"/>个ROM</a>
			  		<div class="mui-collapse-content">
			  			<a href="mobileShowNewestModelRom?model.modelid=<s:property value='#request.classmodel.modelid'/>&currentPage=1">最新</a>&nbsp;&nbsp;
			  			<a href="mobileShowHotestModelRom?model.modelid=<s:property value='#request.classmodel.modelid'/>&currentPage=1">最热</a>
			  		</div>
			  	</li>
		  	</ul>
