...
<html>
  <head>
    ...
    <title><s:property value="#request.classuitype.uitype"/> ROM|刷机包下载</title>
  ...
  <body>
	...
	<div class="mui-content">
		<div class="model-roms">
			<h4><a href="mobileShowUiType">UI专区</a> > <span><s:property value='#request.classuitype.uitype'/></span></h4>
			<ul class="mui-table-view">
				<li class="mui-table-view-cell mui-collapse">
			  		<a class="mui-navigate-right" href="#">共<s:property value="#request.romnum"/>个ROM</a>
			  		<div class="mui-collapse-content">
			  			<a href="mobileShowNewestUitypeRom?uitype.uiid=<s:property value='#request.classuitype.uiid'/>&currentPage=1">最新</a>&nbsp;&nbsp;
			  			<a href="mobileShowHotestUitypeRom?uitype.uiid=<s:property value='#request.classuitype.uiid'/>&currentPage=1">最热</a>
			  		</div>
			  	</li>
		  	</ul>
			<ul class="mui-table-view mui-grid-view mui-grid-9">
				...
				<s:else>
					<h4 align="center">共<s:property value="#request.classuitype.uitype"/>下暂时没有ROM</h4>
				</s:else>
			</ul>
		</div>
